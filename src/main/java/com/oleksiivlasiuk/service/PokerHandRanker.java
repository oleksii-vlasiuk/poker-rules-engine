...
public class PokerHandRanker {
    public List<Hand> rankHands(List<Hand> hands) {
        // instead of the Int comparation add handComparator
//        hands.sort(Comparator.comparingInt(this::getHandRank).reversed());
        hands.sort(new HandComparator().reversed());
        return hands;
    }

/*    private int getHandRank(Hand hand) {
        return cardCombinationEvaluator(hand);
    }*/

    /*private int cardCombinationEvaluator(Hand hand) {
